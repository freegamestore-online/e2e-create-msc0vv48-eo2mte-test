...
export default defineConfig({
  plugins: [
    ...
    VitePWA({
      ...
      manifest: {
        name: "Browser Canary e2e-create-msc0vv48-eo2mte-test",
        short_name: "Browser Canary e2e-create-msc0vv48-eo2mte-test",
        description: "Browser Canary e2e-create-msc0vv48-eo2mte-test — free forever",
        start_url: "/",
        display: "standalone",
